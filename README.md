...
[v0.42.0](https://github.com/cpm-cmake/CPM.cmake/releases/tag/v0.42.0) for dependency management.
...
3. Switch to the desired branch or release tag: `git checkout v1.7.1`.
