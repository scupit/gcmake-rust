...
lazy_static! {
  ...
  static ref VALID_CPP_FEATURES: HashMap<&'static str, &'static str> = HashMap::from([
    ...
    // Language features
    ("template_templates", "template_template_parameters"),
    ("alignas", "alignas"),
    ("alignof", "alignof"),
    ("attributes", "attributes"),
    ("auto", "auto_type"),
    ("constexpr", "constexpr"),
    ("decltype_incomplete_return_types", "decltype_incomplete_return_types"),
    ("decltype", "decltype"),
    ("decltype", "decltype"),
    ("default_function_template_args", "default_function_template_args"),
    ("defaulted_functions", "defaulted_functions"),
    ("defaulted_move_initializers", "defaulted_move_initializers"),
    ("delegating_constructors", "delegating_constructors"),
    ("deleted_functions", "deleted_functions"),
    ("enum_forward_declare", "enum_forward_declarations"),
    ("explicit_conversions", "explicit_conversions"),
    ("extended_friend_declarations", "extended_friend_declarations"),
    ("extern_templates", "extern_templates"),
    ("final", "final"),
    ("func_identifier", "func_identifier"),
    ("generalized_initializers", "generalized_initializers"),
    ("inheriting_constructors", "inheriting_constructors"),
    ("inline_namespaces", "inline_namespaces"),
    ("lambdas", "lambdas"),
    ("local_type_template_args", "local_type_template_args"),
    ("long_long", "long_long_type"),
    ("noexcept", "noexcept"),
    ("nonstatic_member_init", "nonstatic_member_init"),
    ("nullptr", "nullptr"),
    ("override", "override"),
    ("range_for", "range_for"),
    ("raw_string_literals", "raw_string_literals"),
    ("ref_qualified_functions", "reference_qualified_functions"),
    ("right_angle_brackets", "right_angle_brackets"),
    ("rvalue_refs", "rvalue_references"),
    ("sizeof_member", "sizeof_member"),
    ("static_assert", "static_assert"),
    ("strong_enums", "strong_enums"),
    ("thread_local", "thread_local"),
    ("trailing_return", "trailing_return_types"),
    ("unicode_literals", "unicode_literals"),
    ("uniform_init", "uniform_initialization"),
    ("unrestricted_unions", "unrestricted_unions"),
    ("user_literals", "user_literals"),
    ("variadic_macros", "variadic_macros"),
    ("variadic_templates", "variadic_templates"),

    ("aggregate_default_initializers", "aggregate_default_initializers"),
    ("attribute_deprecated", "attribute_deprecated"),
    ("binary_literals", "binary_literals"),
    ("contextual_conversions", "contextual_conversions"),
    ("decltype_auto", "decltype_auto"),
    ("digit_separators", "digit_separators"),
    ("generic_lambdas", "generic_lambdas"),
    ("lambda_init_captures", "lambda_init_captures"),
    ("relaxed_constexpr", "relaxed_constexpr"),
    ("return_type_deduction", "return_type_deduction"),
